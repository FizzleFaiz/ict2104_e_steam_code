...
//  UART_WRITE(EUSCI_A2_BASE, buf, len);//uart write
//}
//
//
...
//  uint8_t subms = 0;
//  for (i = 0; i < len; i++) {
//    while (UART_Available(EUSCI_A2_BASE)) {//UART available?
//      delayMicroseconds(10);//check ESP
//      if (++subms >= 100) {
//        if (timeout_ms == 0) {
//          return i;
//        }
...
//      }
//    }
//    buf[i] = UART_Read(EUSCI_A2_BASE, buf, len);//UART READ?
//  }
//  return i;
//}
//
